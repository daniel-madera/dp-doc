...
\section{Návrh aplikace}
    ...
    \subsection{Obtížnost slovíček}
        ...
        \subsubsection{Levenshteinova vzdálenost}
            ...
            Vzorec níže je matematický zápis Levenshteinovy vzdálenosti, kde $a$ a $b$ jsou řetězce $a(i)$ a $b(j)$ jsou indexované znaky v řetězcích. Výsledná vzdálenost je rovna hodnotě v matici $dist_{a,b}$ na pozici $dist_{a,b}(|a|,|b|)$, kde $|a|$ a $|b|$ jsou délky řetězců \cite{bib:levenshtein}.
            \[dist_{a,b}(i,j) = 
                \begin{cases} 
        ...
        \subsubsection{Praktický příklad Levenshteinovy vzdálenosti}

            % rozvést adaptovanou levenshteinovu vzdálenot?
